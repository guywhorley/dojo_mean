console.log('>> Loading: "client/assets/controllers/edit_controller.js"');

// 'EditController' is the name to use in the routeProvider
...
console.log(">> Done loading edit_controller");